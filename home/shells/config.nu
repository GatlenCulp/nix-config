...
# enable the package and integration below
...
# fish completions are added via extraConfig in nushell.nix (requires Nix interpolation)
...
# Update config with completions
