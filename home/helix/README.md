...
2. Helix - Modern builtin features: LSP, tree-sitter, fuzzy finder, multi cursors, surround and
   more.
   1. They're all available in Neovim too, but you need to find and use the right plugins manually,
      which takes time and effort.
3. Helix is built in Rust from scratch. The result is a much smaller codebase and a modern set of
   defaults. No VimScript. No Lua.
   1. Neovim contains a lot of VimScript, and lua is too dynamic, it's hard to debug.
   2. Personally I'm glad to take a look at a Rust codebase, but not a VimScript/Lua codebase.
4. Neovim have a very activate plugin ecosystem, and it's easy to find plugins for almost
   everything.
   1. Helix is still new, and it even don't have a stable plugin system yet. A PR to add a plugin
      system is still envolving: [https://github.com/helix-editor/helix/pull/8675](https://github.com/helix-editor/helix/pull/8675)
5. Neovim has integrated terminal, and it's very powerful. It's quite similar to VSCode's integrated
   ...
   2. [https://github.com/helix-editor/helix/issues/1976#issuecomment-1091074719](https://github.com/helix-editor/helix/issues/1976#issuecomment-1091074719)
   3. [https://github.com/helix-editor/helix/pull/4649](https://github.com/helix-editor/helix/pull/4649)
   4. **My Neovim often gets stuck when I switch to
...
6. Helix do not have a tree-view panel, it's recommended to use Yazi/ranger/Broot instead, and open
   Helix in them.
...
7. It seems Helix lacks a global substitution command, you should run it in another window(via wm or
   Zellij).
   1. [https://github.com/helix-editor/helix/issues/196](https://github.com/helix-editor/helix/issues/196)
   2. Neovim's substitution command allow you to preview the changes before you apply it, and it's
...
8. Complexity and Maintenance Costs vs Batteries Included:
   [https://github.com/helix-editor/helix/discussions/6356](https://github.com/helix-editor/helix/discussions/6356)
